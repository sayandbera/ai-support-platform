(function () {
  "use strict";
  const o = {
      WIDGET_URL: "https://ai-support-platform-widget-xi.vercel.app",
  ...
  (function () {
    ...
    if (!r) {
      console.error(
        "AI Support Platform Widget: data-organization-id attribute is required"
      );
      return;
    }
    function h() {
    ...
    function f() {
      (e = document.createElement("button")),
        (e.id = "ai-support-platform-widget-button"),
        (e.innerHTML = u),
        (e.style.cssText = `
      position: fixed;
    ...
    `),
        ...
        (t.id = "ai-support-platform-widget-container"),
        (t.style.cssText = `
      position: fixed;
      ${a === "bottom-right" ? "right: 20px;" : "left: 20px;"}
      bottom: 90px;
    ...
    function w() {
      ...
      return i.append("orgId", r), `${o.WIDGET_URL}?${i.toString()}`;
    }
    function g(i) {
    ...
    (window.AISupportPlatformWidget = {
      init: v,
      show: m,
      hide: p,
      destroy: x,
